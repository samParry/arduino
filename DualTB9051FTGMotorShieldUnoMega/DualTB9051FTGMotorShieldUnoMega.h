...
class DualTB9051FTGMotorShieldUnoMega
{
  public:
    ...
    DualTB9051FTGMotorShieldUnoMega();

    // User-defined pin selection.
    DualTB9051FTGMotorShieldUnoMega(unsigned char M1EN,
                             unsigned char M1DIR,
                             unsigned char M1PWM,
    ...
    void enableDrivers(); // Enables the drivers for both motors.
    void disableM1Driver(); // Disable the driver for M1.
    void disableM2Driver(); // Disable the driver for M2.
    void disableDrivers(); // Disable the drivers for both motors.
